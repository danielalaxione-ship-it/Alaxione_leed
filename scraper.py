    ...
    with sync_playwright() as p:
        ...
        for i, url in enumerate(place_urls):
            ...
            try:
                ...
                # ⚡ Bolt Optimization: Use text_content() instead of inner_text() to avoid implicit visibility checks.
                # text_content() fetches the text directly from the DOM, avoiding Playwright's expensive layout calculations.
